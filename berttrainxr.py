...
model = EncoderDecoderModel.from_pretrained("./checkpoint-30500")
model.to("cuda")

test_data = datasets.load_dataset("reddit", "3.0.0", split="train", ignore_verifications=True)
test_data = test_data.select(range(192417))
...
def generate_summary(batch):
    ...
    inputs = tokenizer(batch["content"], padding="max_length", truncation=True, max_length=512, return_tensors="pt")
